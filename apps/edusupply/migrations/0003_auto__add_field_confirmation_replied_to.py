...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Confirmation.replied_to'
        db.add_column('edusupply_confirmation', 'replied_to', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Confirmation.replied_to'
        db.delete_column('edusupply_confirmation', 'replied_to')
