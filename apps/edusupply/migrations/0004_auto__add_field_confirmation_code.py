...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Confirmation.code'
        db.add_column('edusupply_confirmation', 'code', self.gf('django.db.models.fields.CharField')(max_length=8, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Confirmation.code'
        db.delete_column('edusupply_confirmation', 'code')
