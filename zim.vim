...
badd +10 apps/logistics/models.py
badd +1 apps/edusupply/extensions/rapidsms/contact.py
badd +0 apps/edusupply/extensions/locations/location.py
badd +99 lib/rapidsms/models.py
...
silent! normal! zE
let s:l = 182 - ((28 * winheight(0) + 15) / 31)
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 88 - ((6 * winheight(0) + 15) / 30)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
88
